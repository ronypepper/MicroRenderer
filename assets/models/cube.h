...
inline UVCGlobalData<float> cube_global_data = {{test_texture_rgb888, 3, 3}};
...
inline UVCTriangleSource<float> cube_triangle_source[12] = {
    {{0.7f, 0.2f, 0.5f}},
    {{0.f, 0.f, 1.f}},
    {{0.f, 1.f, 0.f}},
    {{0.f, 1.f, 1.f}},
...
inline UVCShaderInterface<float>::ModelData cube_model = {
    8, 12, cube_vertex_source1, cube_triangle_source, cube_indices
};
