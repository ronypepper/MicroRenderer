...
inline UVCTriangleSource<float> rasterization_test_triangle_source[rasterization_test_triangle_num] = {
    {{1.f, 0.f, 0.f}},
    {{0.f, 1.f, 0.f}},
    {{1.f, 1.f, 0.f}},
    {{0.f, 0.f, 1.f}},
...
inline UVCShaderInterface<float>::ModelData rasterization_test_model = {
    ...
    rasterization_test_triangle_source, rasterization_test_indices
};
